...
HD_PWD='C:/SSC/MetodaFaraRefacereaRestului/MetodaFaraRefacereaRestului.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ImplementarePlaca.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ImplementarePlaca.tcl -notrace
