...
HD_PWD='C:/SSC/MetodaFaraRefacereaRestului/MetodaFaraRefacereaRestului.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ImplementarePlaca.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ImplementarePlaca.tcl
