...
HD_PWD='C:/SSC/MetodaRefaceriiRestului/Proiect.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log implementare_placa.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source implementare_placa.tcl -notrace
