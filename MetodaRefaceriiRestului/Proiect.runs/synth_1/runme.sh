...
HD_PWD='C:/SSC/MetodaRefaceriiRestului/Proiect.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log implementare_placa.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source implementare_placa.tcl
